...
const cards = [
  ...
  },
  {
    ...
    description: "Study chess openings with engine-scored moves. Explore lines, win rates, and best moves from any position.",
    color: "#60a5fa",
  ...
  },
  {
    ...
    emoji: "🔍",
    title: "Player Lookup",
    description: "Search any player on Chess.com and Lichess simultaneously — see ratings, games, win rates and profile stats.",
    color: "#c084fc",
